    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden max-w-4xl">
        <form action="{{ route('penempatan.store') }}" method="POST" class="p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div class="col-span-1">
                    ...
                    <input type="text" id="nama" name="nama" placeholder="Contoh: Ahmad Santoso" required
                        class="w-full px-4 py-3 rounded-xl border border-gray-200 bg-[#F8FAFC] text-[15px] focus:outline-none focus:ring-2 focus:ring-[#12395B]/20 focus:border-[#12395B] transition placeholder-gray-400">
                </div>
                ...
                <div class="col-span-1">
                    ...
                    <input type="date" id="tanggal" name="tanggal"
                        class="w-full px-4 py-3 rounded-xl border border-gray-200 bg-[#F8FAFC] text-[15px] text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#12395B]/20 focus:border-[#12395B] transition">
                ...
                <div class="col-span-1">
                    ...
                    <div class="relative">
                        <select id="status" name="status" required
                            class="w-full appearance-none px-4 py-3 rounded-xl border border-gray-200 bg-[#F8FAFC] text-[15px] text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#12395B]/20 focus:border-[#12395B] transition cursor-pointer">
            ...
            <div class="mt-10 flex items-center justify-end gap-4 pt-6 border-t border-gray-100">
                ...
                <button type="submit" class="bg-[#12395B] hover:bg-[#0d2a43] text-white px-8 py-2.5 rounded-full font-semibold text-[14px] shadow-sm transition flex items-center gap-2">
